...
import { CicloFinanceiroRoutingModule } from './ciclo-financeiro-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    NbAccordionModule,
    NbUserModule,
    CicloFinanceiroRoutingModule
  ],
  declarations: [
    CicloFinanceiroComponent
    
  ],
})
export class CicloFinanceiroModule { }
